...
import static az.ingress.mapper.RatingCacheOutboxMapper.RATING_CACHE_OUTBOX_MAPPER
...
class RatingCacheOutboxMapperTest extends Specification {
    ...
    def "BuildOutboxEntityTest"(){
        ...
        when:
        def response = RATING_CACHE_OUTBOX_MAPPER.buildOutBoxEntity(productId,cacheDto)
