...
import static az.ingress.mapper.RatingMapper.*
...
class RatingMapperTest extends Specification {
    ...
    def "BuildRatingEntityTest"() {
        ...
        when:
        def entity = RATING_MAPPER.buiildRatingEntity(request)
    ...
    def "BuildRatingResponseTest"(){
        ...
        when:
        def response  = RATING_MAPPER.buildRatingResponse(entity)
    ...
    def "UpdateRatingEntityTest"() {
        ...
        when:
        RATING_MAPPER.updateRatingEntity(entity, request)
    ...
    def "BuildRatingDtoTest"(){
        ...
        when:
        def response = RATING_MAPPER.buildRatingDto(entity)
